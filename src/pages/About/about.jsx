...
import LogoG from "../../assets/img/logo-icon.png";
      ...
      <section>
        <div className="header-text">
          <div className="about-header">
            ...
            <p>
              Na InovaTech, nossa paixão por inovação e tecnologia nos
              impulsiona a entregar soluções de ponta que transformam ideias em
              realidade. Fundada por entusiastas da tecnologia, nossa missão é
              capacitar indivíduos e empresas com ferramentas e conhecimentos
              essenciais para prosperar no mundo digital em constante evolução.
            </p>
          </div>
        ...
        <div>
          ...
          <p>
            ...
            nossos clientes e parceiros. Junte-se a nós nessa jornada de
            transformação e descubra como podemos ajudar a levar suas ideias ao
            próximo nível.
          </p>
        </div>
      </section>
